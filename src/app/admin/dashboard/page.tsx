    ...
    <div style={{ padding: "48px" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 36 }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <Link href="/admin/events/new" style={{ display:"flex",alignItems:"center",gap:8,padding:"11px 18px",borderRadius:14,fontSize:13,fontWeight:700,textDecoration:"none",background:"rgba(255,255,255,0.80)",border:"1px solid var(--border)",color:"var(--text)",boxShadow:"0 6px 16px rgba(31,90,110,0.06)" }}>
            <Calendar style={{ width:15,height:15,color:"var(--primary)" }} /> Etkinlik
          </Link>
          <Link href="/admin/posts/new" style={{ display:"flex",alignItems:"center",gap:8,padding:"11px 18px",borderRadius:14,fontSize:13,fontWeight:700,textDecoration:"none",background:"linear-gradient(135deg,var(--primary),var(--secondary))",color:"#fff",boxShadow:"0 10px 24px rgba(27,154,170,0.28)" }}>
      ...
      <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:18 }}>
        ...
        <div style={{ background:"rgba(255,255,255,0.76)",border:"1px solid rgba(255,255,255,0.86)",borderRadius:24,overflow:"hidden",boxShadow:"0 12px 28px rgba(31,90,110,0.08)" }}>
          <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",padding:"18px 20px",borderBottom:"1px solid rgba(22,48,64,0.07)" }}>
            ...
            <Link href="/admin/posts" style={{ fontSize:12,fontWeight:700,color:"var(--primary)",textDecoration:"none",display:"flex",alignItems:"center",gap:4 }}>Tümü <ArrowRight style={{ width:12,height:12 }} /></Link>
          </div>
          {(posts as any[]).map(p => (
            <Link key={p.id} href={`/admin/posts/${p.id}`} style={{ display:"flex",alignItems:"center",gap:12,padding:"12px 20px",textDecoration:"none",borderBottom:"1px solid rgba(22,48,64,0.04)" }}>
        ...
        <div style={{ background:"rgba(255,255,255,0.76)",border:"1px solid rgba(255,255,255,0.86)",borderRadius:24,overflow:"hidden",boxShadow:"0 12px 28px rgba(31,90,110,0.08)" }}>
          <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",padding:"18px 20px",borderBottom:"1px solid rgba(22,48,64,0.07)" }}>
            ...
            <Link href="/admin/messages" style={{ fontSize:12,fontWeight:700,color:"var(--primary)",textDecoration:"none",display:"flex",alignItems:"center",gap:4 }}>Tümü <ArrowRight style={{ width:12,height:12 }} /></Link>
          </div>
          {(msgs as any[]).map(m => (
        ...
        <div style={{ background:"rgba(255,255,255,0.76)",border:"1px solid rgba(255,255,255,0.86)",borderRadius:24,overflow:"hidden",boxShadow:"0 12px 28px rgba(31,90,110,0.08)" }}>
          <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",padding:"18px 20px",borderBottom:"1px solid rgba(22,48,64,0.07)" }}>
            ...
            <Link href="/admin/events" style={{ fontSize:12,fontWeight:700,color:"var(--primary)",textDecoration:"none",display:"flex",alignItems:"center",gap:4 }}>Tümü <ArrowRight style={{ width:12,height:12 }} /></Link>
          </div>
          {(events as any[]).map(ev => {
            const d = new Date(ev.event_date);
            return (
              <Link key={ev.id} href={`/admin/events/${ev.id}`} style={{ display:"flex",alignItems:"center",gap:12,padding:"12px 20px",textDecoration:"none",borderBottom:"1px solid rgba(22,48,64,0.04)" }}>
