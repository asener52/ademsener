  ...
  return (
    <div style={{ padding: 48, maxWidth: 760 }}>
      <div style={{ marginBottom: 24 }}>
        <Link href="/yonetim/surveys" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 13, fontWeight: 600, color: "var(--muted)", marginBottom: 16, textDecoration: "none" }}>
